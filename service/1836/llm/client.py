...
_PIPE_ENV = Path(__file__).resolve().parents[2] / "和QQ的通信管线" / ".env"
...
_parse_dotenv(_ROOT / ".env")
# QQ 管线 .env 仅作本机开发兜底；请求包应通过 RequestConfig.env_file 显式指定
_parse_dotenv(_PIPE_ENV)
