...
_impl = _SF / "tools.py"
_spec = importlib.util.spec_from_file_location("patchouli_script_find_tools_hoi4", _impl)
assert _spec and _spec.loader
_mod = importlib.util.module_from_spec(_spec)
sys.modules["patchouli_script_find_tools_hoi4"] = _mod
